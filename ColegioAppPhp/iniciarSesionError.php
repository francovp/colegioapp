...
<div class="container-fluid">
    <form class="form-horizontal" action="login.php" method="POST">
        ...
        <div class="form-group">
            <label for="ingresoUsername" class="col-sm-offset-1 col-sm-2 control-label">Usuario</label>
            <div class="col-sm-8">
                <input type="text" id="ingresoUsername" name="username" class="form-control" placeholder="Nombre de usuario" required autofocus><br>
            </div>
        </div>
        <div class="form-group">
            <label for="ingresoPassword" class="col-sm-offset-1 col-sm-2 control-label">Contraseña</label>
            <div class="col-sm-8">
                <input type="password" id="ingresoPassword" name="pass" class="form-control" placeholder="Contraseña" required autofocus><br>
            </div>
        </div>
        <h3><span class="label label-danger">Error! Usuario o contraseña incorrecta </span></h3>
        <br />
        <div class="form-group">
